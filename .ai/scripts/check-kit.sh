...
for adapter in .github/copilot-instructions.md .github/workflows/gates.yml .cursor/rules/ai-kit.mdc .agents/AGENTS.md GEMINI.md ANTIGRAVITY.md .githooks/pre-commit; do
