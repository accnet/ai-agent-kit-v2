...
for adapter in .github/copilot-instructions.md .github/workflows/gates.yml .cursor/rules/ai-kit.mdc .agents/AGENTS.md .githooks/pre-commit CLAUDE.md ANTIGRAVITY.md; do
